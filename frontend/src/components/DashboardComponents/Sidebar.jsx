  ...
  return (
    <div className="flex flex-col bg-neutral-900 w-60 p-3">
      ...
      <div className="flex flex-col space-y-0.5 pt-2 border-t border-neutral-700">
        ...
        <div
          className={`flex items-center space-x-2 font-light px-3 py-2 hover:bg-neutral-700 hover:no-underline active:bg-neutral-600 rounded-sm text-red-500 cursor-pointer `}
        >
